...
- Learn how to use Claude effectively
- Build my first structured workflow
- Practice Git + VS Code interaction

---

## Tasks
- [x] Open VS Code workspace
- [x] Create first Python script
- [x] Use Claude for explanation
...
- Fluid flowing downhill  
- Asked guiding questions to build reasoning step-by-step:  
- Why does water speed up at a narrow nozzle?  
...
- Pressure is correctly defined as **F/A (force per unit area)**  
  
- **Relationship between area, velocity, and pressure**  
- Incorrect assumption: area ↓ → pressure ↑ → velocity ↑  
...
- Reinforced structured reasoning approach for physics problems
